...
<body data-page="page1">
                    ...
                    <div class="container-lg">
                        <div class="row align-items-center justify-content-center">
                            <div class="col-lg-6 col-sm-6 mb-3" id="home-content1">
                                ...
                                <a href="view.html" class="btn">Shop Now</a>
                            </div>
    ...
    <section id="product">
        ...
        <div id="product-link">
            <a href="#" class="product product-active" onclick="activeProduct(event,'rowLayout','swiperLayout')">Features</a>
            <a href="#" class="product" onclick="activeProduct(event,'bestRowLayout','bestSwiperLayout')">Best Sellers</a>
            <a href="#" class="product" onclick="activeProduct(event,'newRowLayout','newSwiperLayout')">New Arrivals</a>
        </div>
        <div id="product-content" class="container-lg mt-4">
            <div class="product-row-layout">
                <div class="row" id="row-layout">
                    <div class="col-lg-3 mb-4">
                        <div id="product-img-content">
                            <img src="{{ asset('image/product4.webp') }}" class="w-100 d-block">
                        ...
                        <div id="product-name" class="mt-2 border px-1 py-1">
                            <h5>Trime Trail Bike</h5>
                            <div class="d-flex" style="color: #a2b2ee;">
                                <label for="" class="me-5">$ 70.00</label>
                                <span>
                ...
                <div class="row" id="best-row-layout">
                    <div class="col-lg-3 mb-4">
                        <div id="product-img-content">
                            <img src="{{ asset('image/product4.webp') }}" class="w-100 d-block">
                            <div id="product-img-link">
                ...
                <div class="row" id="new-row-layout">
                    <div class="col-lg-3 mb-4">
                        <div id="product-img-content">
                            <img src="{{ asset('image/product4.webp') }}" class="w-100 d-block">
                            <div id="product-img-link">
                        ...
                        <div id="product-name" class="mt-2 border px-1 py-1">
                            <h5>Commuting Bike</h5>
                            <div class="d-flex" style="color: #a2b2ee;">
                                <label for="" class="me-5">$ 98.00</label>
                                <span>
                                    <i class="fa-solid fa-star"></i>
                                    <i class="fa-solid fa-star"></i>
                                    <i class="fa-solid fa-star"></i>
            ...
            <div class="container-lg product-swiper-layout">
                    ...
                    <div class="swiper-wrapper">
                        <div class="swiper-slide">
                            ...
                            <div id="product-name" class="mt-2 border px-1 py-1 text-center">
                                <h5>Kids Sport Bike</h5>
                                <div class="d-flex justify-content-center" style="color: #a2b2ee;">
                                    <label for="" class="me-5">$ 63.00</label>
                                    <span>
                                        <i class="fa-solid fa-star"></i>
                                        <i class="fa-solid fa-star-half-stroke"></i>
                                        <i class="fa-regular fa-star"></i>
                ...
                <div class="swiper" id="best-swiper-layout">
                    <div class="swiper-wrapper">
                        <div class="swiper-slide">
                            <div id="product-img-content">
                                <img src="{{ asset('image/product4.webp') }}" class="w-100 d-block">
                ...
                <div class="swiper" id="new-swiper-layout">
                    <div class="swiper-wrapper">
                        <div class="swiper-slide">
                            <div id="product-img-content">
                                <img src="{{ asset('image/product4.webp') }}" class="w-100 d-block">
        ...
        <div class="product-pagination">
            ...
            <div class="best-pagination text-center mx-auto mt-3"></div>
            <div class="new-pagination text-center mx-auto mt-3"></div>
        </div>
    </section>
    <!-- product end  -->
        ...
        <div class="container-lg mt-5">
            <div class="row mx-auto">
                <div class="col-lg-4 col-sm-6 mb-4">
                    ...
                    <hr>
                    <div class="card-container1 mt-3">
                        <div class="row mb-3 card1 align-items-center justify-content-center">
                            <div class="col-lg-5 col-sm-5" id="card-shop">
                                <img src="{{ asset('image/product4.webp') }}" class="w-100 d-block">
                                <div id="card-img-link">
                                    <a href="javascript:void(0)" id="eye"><i class="fa-solid fa-eye"></i></a>
                                    <a href="javacript:void(0)" id="shop"><i class="fa-solid fa-cart-shopping"></i></a>
                                </div>
                            </div>
                            <div class="col-lg-7 col-sm-7" id="card-shop-content">
                                <h5>A Folding Bike</h5>
                                <label class="d-block">$ 59.22</label>
                                <span>
                                    <i class="fa-solid fa-star"></i>
                                    <i class="fa-solid fa-star"></i>
                                    <i class="fa-solid fa-star-half-stroke"></i>
                    ...
                    <div class="card-container2 mt-3">
                        <div class="row mb-3 card2 align-items-center justify-content-center">
                            <div class="col-lg-5 col-sm-5" id="card-shop">
                                <img src="{{ asset('image/product5.webp') }}" class="w-100 d-block">
                                <div id="card-img-link">
                                    <a href="javascript:void(0)" id="eye"><i class="fa-solid fa-eye"></i></a>
                                    <a href="javacript:void(0)" id="shop"><i class="fa-solid fa-cart-shopping"></i></a>
                                </div>
                            ...
                            <div class="col-lg-7 col-sm-7" id="card-shop-content">
                                <h5>Classic Bike</h5>
                                <label class="d-block">$ 30.22</label>
                                <span>
                                    <i class="fa-regular fa-star"></i>
                                    <i class="fa-regular fa-star"></i>
                                    <i class="fa-regular fa-star"></i>
                    ...
                    <div class="card-container3 mt-3">
                        <div class="row mb-3 card3 align-items-center justify-content-center">
                            <div class="col-lg-5 col-sm-5" id="card-shop">
                                <img src="{{ asset('image/product6.webp') }}" class="w-100 d-block">
                                <div id="card-img-link">
                                    <a href="javascript:void(0)" id="eye"><i class="fa-solid fa-eye"></i></a>
                                    <a href="javacript:void(0)" id="shop"><i class="fa-solid fa-cart-shopping"></i></a>
                                </div>
                            ...
                            <div class="col-lg-7 col-sm-7" id="card-shop-content">
                                <h5>Cyclocross Bike</h5>
                                <label class="d-block">$ 69.22</label>
                                <span>
                                    <i class="fa-solid fa-star"></i>
                                    <i class="fa-regular fa-star"></i>
                                    <i class="fa-regular fa-star"></i>
                ...
                <div class="col-lg-4 col-sm-6 mb-4">
                    ...
                    <hr>
                    <div class="card-container1 mt-3">
                        <div class="row mb-3 card4 align-items-center justify-content-center">
                            <div class="col-lg-5 col-sm-5" id="card-shop">
                                <img src="{{ asset('image/product4.webp') }}" class="w-100 d-block">
                                <div id="card-img-link">
                                    <a href="javascript:void(0)" id="eye"><i class="fa-solid fa-eye"></i></a>
                    ...
                    <div class="card-container2 mt-3">
                        <div class="row mb-3 card5 align-items-center justify-content-center">
                            <div class="col-lg-5 col-sm-5" id="card-shop">
                                <img src="{{ asset('image/product5.webp') }}" class="w-100 d-block">
                                <div id="card-img-link">
                                    <a href="javascript:void(0)" id="eye"><i class="fa-solid fa-eye"></i></a>
                    ...
                    <div class="card-container3 mt-3">
                        <div class="row mb-3 card6 align-items-center justify-content-center">
                            <div class="col-lg-5 col-sm-5" id="card-shop">
                                <img src="{{ asset('image/product6.webp') }}" class="w-100 d-block">
                                <div id="card-img-link">
                                    <a href="javascript:void(0)" id="eye"><i class="fa-solid fa-eye"></i></a>
                ...
                <div class="col-lg-4 col-sm-6 mx-auto">
                    ...
                    <hr>
                    <div class="card-container1 mt-3">
                        <div class="row mb-3 card7 align-items-center justify-content-center">
                            <div class="col-lg-5 col-sm-5" id="card-shop">
                                <img src="{{ asset('image/product4.webp') }}" class="w-100 d-block">
                                <div id="card-img-link">
                                    <a href="javascript:void(0)" id="eye"><i class="fa-solid fa-eye"></i></a>
                    ...
                    <div class="card-container2 mt-3">
                        <div class="row mb-3 card8 align-items-center justify-content-center">
                            <div class="col-lg-5 col-sm-5" id="card-shop">
                                <img src="{{ asset('image/product5.webp') }}" class="w-100 d-block">
                                <div id="card-img-link">
                                    <a href="javascript:void(0)" id="eye"><i class="fa-solid fa-eye"></i></a>
                    ...
                    <div class="card-container3 mt-3">
                        <div class="row mb-3 card9 align-items-center justify-content-center">
                            <div class="col-lg-5 col-sm-5" id="card-shop">
                                <img src="{{ asset('image/product6.webp') }}" class="w-100 d-block">
                                <div id="card-img-link">
                                    <a href="javascript:void(0)" id="eye"><i class="fa-solid fa-eye"></i></a>
