...
<body data-page="page2">
            ...
            <form action="">
                <div class="row align-items-center justify-content-center mx-auto pb-4">
                    <div class="col-lg-6 col-md-6">
                        <img src="{{ asset('storage/'.$products->image) }}" class="w-100 d-block">
                    </div>
                    <div class="col-lg-6 col-md-6 mt-3">
                        ...
                        <div id="product-details">
                            <div class="mb-2">
                                <label>Availability : <span>In Stock <i class="fa-solid fa-check text-success"></i></span></label>
                                <label>Price : <span>{{ $products->price }} Kyats</span></label>
                                <label>Viewer : <span>{{ $products->view_count }}</span></label>
                                <label>Category : <span>{{ $products->category_name}}</span></label>
                                <div id="size-check">
                                    <label class="d-inline-block">Size : </label>
                                    <div id="size-links">
                                        <a href="#" class="size size-active" onclick="activeSize(event, 17)">M</a>
                                        <a href="#" class="size" onclick="activeSize(event, 6)">L</a>
                                        <a href="#" class="size" onclick="activeSize(event, 10)">XL</a>
                                    </div>
                                </div>
                            </div>
                            <small id="product-left">Hurry up! only <span class="product-left-count">17</span> products left in stock!</p>
                            <p style="font-family: calibri;">{{ $products->description }}</p>
                        </div>
    ...
    <section id="details-text-content" class="bg-dark py-5">
        <ul id="details-text">
            <li><a href="javascript:void(0)" class="text-content text-active" onclick="detailsClick(event,'textParagraph')">Description</a></li>
            <li><a href="javascript:void(0)" class="text-content" onclick="detailsClick(event,'addInfo')">Additional Information</a></li>
            <li><a href="javascript:void(0)" class="text-content" onclick="detailsClick(event,'reviewsInfo')">Reviews</a></li>
        </ul>
        <div id="details-show">
            <div id="text-paragraph" class="px-4 mt-3 mx-auto">
                <div>
                    <h5>More Details</h5>
                    <ul>
                        ...
                        <li>Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the standard dummy text. Lorem Ipsum has been the industr standard dummy text ever since. Lorem Ipsum is simply dummy text.</li>
                    </ul>
                </div>
                <div>
                    ...
                    <ul>
                        ...
                        <li>Ipsum is simply dummy text of the printing and typesetting industry.</li>
            ...
            <div id="add-info" class="px-4 mt-3 mx-auto">
                <table width="80%" height="140px" align="center" cellpadding="8px">
                    <tr align="center">
                        <th>Inventor</th>
                        <th>Types</th>
                        <th>Application</th>
                    ...
                    <tr>
                        <td>Karl von Drais, Kirkpatrick MacMillan</td>
                        <td>Mountain bicycle, racing bicycle, touring bicycle, hybrid bicycle, BMX bike, fixed gear, folding bicycle, electric bicycle</td>
                        <td>Transportation</td>
                    </tr>
                </table>
            </div>
            <div id="reviews-info" class="px-4 mt-3 mx-auto">
                <div>
                    <h5>Customer Reviews</h5>
                    <label class="d-block py-2">No reviews yet</label>
                    <div id="rev-dropdown">
                        <div id="rev-toggle" class="mb-4 d-flex align-items-center border border-1 w-25 py-2 justify-content-center">
                        ...
                        <div id="rev-form">
                            ...
                            <div class="container-lg bg-gradient rounded p-3 border-info">
                                <form action="" id="rev-form-content" class="row">
                                    ...
                                    <div class="col-lg-6 col-md-6 mb-3">
                                        ...
                                        <div class="">
                                            <input type="email" class="form-control" placeholder="jhon@example.com">
                                        </div>
                                    </div>
                                    <div class="col-lg-12 mb-3">
                                        <label for="" class="col-form-label fs-6">Review Title</label>
                                        <div class="">
                                            <input type="text" class="form-control" placeholder="Give your review title">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-lg-12 mb-3">
                                        ...
                                        <textarea name="" id="comment" cols="40" rows="8" class="w-100 form-control"
    ...
    <section id="related-product" class="mb-5 px-5">
                ...
                @foreach ($productList as $p)
                    <div class="swiper-slide">
                        <div id="product-img-content">
                            <img src="{{ asset('storage/'.$p->image) }}" class="w-100 d-block" style="height: 290px;">
                            <div id="product-img-link">
                                <a href="javascript:void(0)" id="eye"><i class="fa-solid fa-eye"></i></a>
                                <a href="javacript:void(0)" id="shop"><i class="fa-solid fa-cart-shopping"></i></a>
                            </div>
                        </div>
