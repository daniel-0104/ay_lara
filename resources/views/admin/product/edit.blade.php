                                ...
                                <div class="card-body">
                                    ...
                                    <form action="{{ route('product#update') }}" method="post" enctype="multipart/form-data">
                                        ...
                                        <div class="row mt-3">
                                            ...
                                            <div class="form-group mt-3">
                                                <label class="control-label mb-1">Waiting Time ( weeks )</label>
                                                <input id="waiting" name="productWaitingTime" type="number" value="{{ old('productWaitingTime',$products->waiting_time) }}"
                                                class="form-control @error('productWaitingTime') is-invalid @enderror" aria-required="true" aria-invalid="false" placeholder="Enter your product waiting time">
