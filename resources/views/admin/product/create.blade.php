                                ...
                                <div class="card-body">
                                    ...
                                    <form action="{{ route('product#create') }}" method="post" novalidate="novalidate" enctype="multipart/form-data">
                                        ...
                                        <div class="form-group mb-4">
                                            ...
                                            class="form-control @error('productWaitingTime') is-invalid @enderror" value="{{ old('productWaitingTime') }}" aria-required="true" aria-invalid="false" placeholder="Enter waiting time">
