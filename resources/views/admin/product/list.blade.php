            ...
            <div class="container-fluid">
                <div class="col-lg-12">
                        ...
                        <div class="table-data__tool-right">
                            <a href="{{ route('product#createPage') }}">
                                <button class="au-btn au-btn-icon au-btn--green au-btn--small">
                                    <i class="zmdi zmdi-plus"></i>Create Bike Brand Name
                                </button>
                            </a>
                            <button class="au-btn au-btn-icon au-btn--green au-btn--small">
                                CSV download
                    ...
                    @if (session('deleteSuccess'))
                            <div class="row">
                                <div class="alert alert-success alert-dismissible fade show col-lg-8 offset-3" role="alert">
                    ...
                    <div class="table-responsive table-responsive-data2">
                        <table class="table table-data2">
                            ...
                            <tbody>
                                ...
                                <tr class="tr-shadow">
                                    <td><img src="{{ asset('storage/'.$p->image) }}" class="img-thumbnail"></td>
                                    <td>{{ $p->name }}</td>
                                    <td>{{ $p->price }}</td>
                    ...
                    @else
                        <h4 class="text-secondary text-center mt-4">There is no product here!</h4>
                    @endif
                    <!-- END DATA TABLE -->
                </div>
            </div>
